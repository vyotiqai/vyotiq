...
Built-in MCP meta tools list server catalogs and request or release server tools. Server-reported tools are separate from the app's built-in catalog (up to 61 tools).
